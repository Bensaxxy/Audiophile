  ...
  return (
    <div className=" py-20 font-primary">
      ...
      <div className=" my-12 w-full">
        <div className=" overflow-hidden text-center md:text-left pt-28 md-28 md:md-0 container flex flex-wrap justify-center items-center lg:gap-20 gap-10 rounded-lg bg-primary">
      ...
      {/*section two 4*/}
      <div className=" my-12 container grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        <div
