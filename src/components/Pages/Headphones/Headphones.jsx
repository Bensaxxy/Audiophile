  ...
  return (
    <div className="font-primary">
      <div className="bg-black">
        <section className="mt-[70px] flex justify-center container flex-col items-center w-full h-[200px]">
      ...
      <div className=" container">
        <div className="py-12">
          <div className=" grid grid-cols-1 lg:grid-cols-2 items-center gap-8 font-primary">
            <div className="w-full bg-cover h-[300px] lg:h-[500px] bg-no-repeat bg-center bg-[url('/src/assets/headphones/mobile/image-product.jpg')] md:bg-[url('/src/assets/headphones/tablet/image-product.jpg')] lg:bg-[url('/src/assets/headphones/desktop/image-product.jpg')]"></div>
        ...
        <div className="py-12">
          <div className=" grid grid-cols-1 lg:grid-cols-2 items-center gap-8 font-primary">
            ...
            <div className="lg:order-2 w-full h-[300px] bg-cover lg:h-[500px] bg-no-repeat bg-center bg-[url('/src/assets/headphones/mobile/image-product-2.jpg')] md:bg-[url('/src/assets/headphones/tablet/image-product-2.jpg')] lg:bg-[url('/src/assets/headphones/desktop/image-product-2.jpg')]"></div>
          </div>
        </div>
        ...
        <div className="py-14">
          <div className=" grid grid-cols-1 lg:grid-cols-2 items-center gap-8 font-primary">
            <div className="w-full bg-cover h-[300px] lg:h-[500px] bg-no-repeat bg-center bg-[url('/src/assets/headphones/mobile/image-category-page-preview.jpg')] md:bg-[url('/src/assets/headphones/tablet/image-product-1.jpg')] lg:bg-[url('/src/assets/headphones/desktop/image-product-1.jpg')]"></div>
            <div className="text-center lg:text-left px-6 lg:px-0">
              <p className="mb-6 text-primary">NEW PRODUCT</p>
              <h1 className="tracking-wider text-3xl sm:text-4xl md:text-[32px] lg:text-[40px] text-secondary uppercase font-bold">
                XX59 Headphones
