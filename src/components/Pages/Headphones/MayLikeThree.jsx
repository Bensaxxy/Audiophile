  ...
  return (
    <div className=" my-20 ">
      ...
      <section className=" container grid gap-8 grid-cols-1 lg:grid-cols-3">
        ...
        <div className=" text-center">
          <div className=" w-full h-[300px] lg:h-[500px] bg-no-repeat bg-contain bg-center bg-[url('/src/assets/headphones/mobile/image-product-2.jpg')] md:bg-[url('/src/assets/headphones/tablet/image-product-2.jpg')] lg:bg-[url('/src/assets/headphones/desktop/image-product-2.jpg')]"></div>
          <h1 className="tracking-wider text-2xl sm:text-3xl md:text-[22px] lg:text-[30px] text-secondary uppercase font-bold mt-8 lg:mt-0">
            XX59
          </h1>
          <button
        ...
        <div className=" text-center">
          ...
          <button className=" rounded-sm bg-primary py-4 px-8 text-gray mt-8 hover:bg-hoverPrimary transition-colors duration-300">
            SEE PRODUCT
          </button>
        </div>
      </section>
